      ...
      <section className="relative z-10 w-full max-w-3xl rounded-3xl bg-white p-6 shadow-2xl sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid gap-5 sm:grid-cols-2">
            <div>
              <label htmlFor="lawyer-name" className="mb-2 block font-semibold">
            ...
            <div>
              <label htmlFor="lawyer-mobile" className="mb-2 block font-semibold">
            ...
            <div>
              <label htmlFor="lawyer-email" className="mb-2 block font-semibold">
